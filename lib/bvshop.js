...
// ─── 發送購物金給會員 ───
// POST /api/v2/customers/point — body: { customerId, point, reason }
export const sendCustomerPoint = async (client, bvCustomerId, point, reason = '') => {
...
export default {
  fetchOrders, fetchCustomers, fetchProducts, syncOrdersForClient,
  verifyCredentials, verifyToken, fetchAccessToken,
